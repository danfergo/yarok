...
class ComponentsManager:
    ...
    def load_tree(self, comp):
        ...
        def walk_tree_recur(parent, elements, parent_component):
            ...
            for element in elements:
                ...
                if has_if:
                    ...
                    condition = eval(condition_str, None, parent_component['config'])
                    if not condition:
                ...
                #         walk_tree_recur(parent, list(element), comp)
                    ...
                    config = self.components_config[sub_component['name_path']] or ConfigBlock({})
                    ...
                    for nested_element in component_content_elements:
                        if 'parent' in nested_element.attrib:
                            ...
                            walk_tree_recur(new_parent, [nested_element], comp)
                        else:
                    ...
                    walk_tree_recur(element, list(element), comp)
        ...
        walk_tree_recur(None, tree, comp)
